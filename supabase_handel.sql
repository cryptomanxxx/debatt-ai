...
grant select on handel_städer to anon;
grant select, insert, update, delete on handel_städer to service_role;
grant select on handel_varor to anon;
grant select, insert, update, delete on handel_varor to service_role;
grant select, update on handel_priser to anon;
grant select, insert, update, delete on handel_priser to service_role;
grant select, insert, update on handel_spelare to anon;
grant select, insert, update, delete on handel_spelare to service_role;
grant select, insert on handel_logg to anon;
grant select, insert, update, delete on handel_logg to service_role;
