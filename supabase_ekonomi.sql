...
grant select on agent_planbocker to anon;
grant select, insert, update, delete on agent_planbocker to service_role;
grant select on ekonomi_spel to anon;
grant select, insert, update, delete on ekonomi_spel to service_role;
grant select on agent_transaktioner to anon;
grant select, insert, update, delete on agent_transaktioner to service_role;
