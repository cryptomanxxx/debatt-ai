...
grant select, insert, update on hedgefonder to anon;
grant select, insert, update, delete on hedgefonder to service_role;
grant select, insert, update, delete on hedgefond_investerare to anon;
grant select, insert, update, delete on hedgefond_investerare to service_role;
grant select, insert on hedgefond_trades to anon;
grant select, insert, update, delete on hedgefond_trades to service_role;
grant select, insert on hedgefond_nav_historik to anon;
grant select, insert, update, delete on hedgefond_nav_historik to service_role;
