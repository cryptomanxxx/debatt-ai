...
grant select, insert, update on constitution_rules to anon;
grant select, insert, update, delete on constitution_rules to service_role;
grant select, insert, update on constitution_amendments to anon;
grant select, insert, update, delete on constitution_amendments to service_role;
grant select, insert on constitution_roster to anon;
grant select, insert, update, delete on constitution_roster to service_role;
