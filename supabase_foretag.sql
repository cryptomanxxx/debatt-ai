...
grant select, insert, update on foretag to anon;
grant select, insert, update, delete on foretag to service_role;
grant select, insert, update on foretag_anstallda to anon;
grant select, insert, update, delete on foretag_anstallda to service_role;
grant select, insert on foretag_intakter to anon;
grant select, insert, update, delete on foretag_intakter to service_role;
