...
def _system_med_stamning(agent: dict, buffs: dict | None = None, status: dict | None = None, koalitions_kontext: str = "", kris_kontext: str = "") -> str:
    """Append mood, symbol-buff instructions, reputation status, coalition bulletin and active crisis to agent system prompt."""
...
def skriv_artikel_om_nyhet(agent: dict, nyhet: dict, extra_kontext: str = "", fmt: dict | None = None, buffs: dict | None = None, status: dict | None = None, koalitions_kontext: str = "", kris_kontext: str = "") -> str:
    """Skriv en debattartikel som kommenterar en aktuell nyhet."""
    if fmt is None:
        fmt = ARTIKELFORMAT[0]
    system = _system_med_stamning(agent, buffs, status, koalitions_kontext, kris_kontext)
...
def skriv_artikel(agent: dict, amne: str, extra_kontext: str = "", fmt: dict | None = None, buffs: dict | None = None, status: dict | None = None, koalitions_kontext: str = "", kris_kontext: str = "") -> str:
...
def skriv_replik(agent: dict, original: dict, relation_kontext: str = "", buffs: dict | None = None, status: dict | None = None, koalitions_kontext: str = "", kris_kontext: str = "") -> str:
