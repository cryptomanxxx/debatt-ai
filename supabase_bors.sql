...
grant select, insert, update, delete on bors_tillgangar to anon;
grant select, insert, update, delete on bors_tillgangar to service_role;
grant select, insert, update, delete on bors_portfoljer to anon;
grant select, insert, update, delete on bors_portfoljer to service_role;
grant select, insert, update, delete on bors_ordrar to anon;
grant select, insert, update, delete on bors_ordrar to service_role;
grant select, insert, update, delete on bors_affarer to anon;
grant select, insert, update, delete on bors_affarer to service_role;
grant select, insert, update, delete on bors_priser to anon;
grant select, insert, update, delete on bors_priser to service_role;
