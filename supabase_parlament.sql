...
grant select on lagforslag to anon;
grant select, insert, update, delete on lagforslag to service_role;
grant select on agent_roster_lag to anon;
grant select, insert, update, delete on agent_roster_lag to service_role;
