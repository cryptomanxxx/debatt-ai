...
config_uppdaterad: "2026-08-28 14:39 UTC"
...
# AI Provider Performance — 2026-08-28

## Hälsostatus

🟢 **100%** lyckade anrop senaste 24h · 515 anrop totalt
...
**Groq (alla nycklar sammanlagt, 24h):** 59 anrop · 59 (100%) OK · 0 (0%) rate-limits · 0 fel

## Per-Provider Statistik (24h)

| Provider | Anrop (24h) | OK | Rate-limits | Errors | Snitt-latens | Senaste benchmark |
|---|---|---|---|---|---|---|
| 🟢 `mistral` | 453 | 453 (100%) | 0 (0%) | 0 | 987 ms | 100% ok · 1120 ms |
| ⚪ `deepseek` _(ej anropad)_ | – | – | – | – | – | 100% ok · 2430 ms |
| ⚪ `cloudflare` _(ej anropad)_ | – | – | – | – | – | 100% ok · 3840 ms |
| 🟢 `groq` | 59 | 59 (100%) | 0 (0%) | 0 | 1146 ms | 100% ok · 840 ms |
...
*(Benchmark senast körde: 2026-08-28 14:39 UTC)*

## 7-Dagars Trend

```
  🟢 mistral          100% ok   (879 anrop, 0 rl, 0 err)
  ⚪ deepseek         ej anropad (7d)  ·  benchmark: 100% ok
  ⚪ cloudflare       ej anropad (7d)  ·  benchmark: 100% ok
  🟢 groq             99% ok   (96 anrop, 1 rl, 0 err)
