...
config_uppdaterad: "2026-08-25 03:39 UTC"
...
# AI Provider Performance — 2026-08-25

## Hälsostatus

🟢 **100%** lyckade anrop senaste 24h · 692 anrop totalt
...
|---|---|---|---|---|---|---|
| 🟢 `mistral` | 656 | 656 (100%) | 0 (0%) | 0 | 1056 ms | 100% ok · 1090 ms |
| ⚪ `deepseek` _(ej anropad)_ | – | – | – | – | – | 100% ok · 2460 ms |
| ⚪ `cloudflare` _(ej anropad)_ | – | – | – | – | – | 100% ok · 3460 ms |
| 🟢 `groq` | 26 | 26 (100%) | 0 (0%) | 0 | 2532 ms | 100% ok · 1440 ms |
...
*(Benchmark senast körde: 2026-08-25 03:39 UTC)*
