...
config_uppdaterad: "2026-08-18 03:35 UTC"
...
# AI Provider Performance — 2026-08-18

## Hälsostatus

🟢 **100%** lyckade anrop senaste 24h · 759 anrop totalt
...
|---|---|---|---|---|---|---|
| 🟢 `mistral` | 725 | 725 (100%) | 0 (0%) | 0 | 1109 ms | 100% ok · 1650 ms |
| ⚪ `deepseek` _(ej anropad)_ | – | – | – | – | – | 100% ok · 2590 ms |
| ⚪ `cloudflare` _(ej anropad)_ | – | – | – | – | – | 100% ok · 3860 ms |
| 🟢 `groq` | 25 | 25 (100%) | 0 (0%) | 0 | 2355 ms | 100% ok · 630 ms |
...
*(Benchmark senast körde: 2026-08-18 03:35 UTC)*
