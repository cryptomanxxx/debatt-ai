...
problem_providers: []
ranked_order: ["mistral", "groq", "deepseek", "cloudflare", "sambanova", "cerebras", "github_models", "gemini"]
config_uppdaterad: "2026-08-29 09:27 UTC"
...
# AI Provider Performance — 2026-08-29

## Hälsostatus

🟢 **100%** lyckade anrop senaste 24h · 632 anrop totalt
...
|---|---|---|---|---|---|---|
| 🟢 `mistral` | 595 | 595 (100%) | 0 (0%) | 0 | 939 ms | 100% ok · 940 ms |
| 🟢 `groq` | 30 | 30 (100%) | 0 (0%) | 0 | 2428 ms | 100% ok · 690 ms |
| ⚪ `deepseek` _(ej anropad)_ | – | – | – | – | – | 100% ok · 2500 ms |
| ⚪ `cloudflare` _(ej anropad)_ | – | – | – | – | – | 100% ok · 3440 ms |
...
`mistral → groq → deepseek → cloudflare → sambanova → cerebras → github_models → gemini`

*(Benchmark senast körde: 2026-08-29 09:27 UTC)*

## 7-Dagars Trend

```
  🟢 mistral          100% ok   (908 anrop, 0 rl, 0 err)
  🟢 groq             100% ok   (84 anrop, 0 rl, 0 err)
