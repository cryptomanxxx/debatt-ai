...
config_uppdaterad: "2026-08-23 03:40 UTC"
...
# AI Provider Performance — 2026-08-23

## Hälsostatus

🟢 **100%** lyckade anrop senaste 24h · 673 anrop totalt
...
|---|---|---|---|---|---|---|
| 🟢 `mistral` | 644 | 644 (100%) | 0 (0%) | 0 | 1109 ms | 100% ok · 1160 ms |
| ⚪ `deepseek` _(ej anropad)_ | – | – | – | – | – | 100% ok · 2360 ms |
| ⚪ `cloudflare` _(ej anropad)_ | – | – | – | – | – | 100% ok · 3620 ms |
| 🟢 `groq` | 26 | 26 (100%) | 0 (0%) | 0 | 2287 ms | 100% ok · 650 ms |
...
*(Benchmark senast körde: 2026-08-23 03:40 UTC)*
