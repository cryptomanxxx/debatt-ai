...
Lägg till återförsök och bättre felhantering. Pseudokod: for (let attempt = 1; attempt <= 3; attempt++) { try { return await sb(table, query); } catch (e) { if (attempt === 3) throw e; await new Promise(r => setTimeout(r, 1000)); } }
