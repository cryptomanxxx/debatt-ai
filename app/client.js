      ...
      <header style={{ borderBottom: `1px solid ${C.border}`, padding: "12px 20px", display: "flex", flexDirection: "column", gap: "10px", position: "sticky", top: 0, background: `${C.bg}f0`, backdropFilter: "blur(12px)", zIndex: 100 }}>
        ...
        <div style={{ display: "flex", gap: "8px", flexWrap: "wrap" }}>
          {[["submit","Hem"],["debatter","Debatter"]].map(([v,lbl])=>(
            <button key={v} onClick={()=>navigate(v)} style={{ display: "inline-flex", alignItems: "center", justifyContent: "center", height: "40px", padding: "0 16px", background: view===v?`${C.accent}25`:"transparent", border: `1px solid ${view===v?C.accent:C.border}`, color: view===v?C.accent:C.textMuted, borderRadius: "4px", cursor: "pointer", fontSize: "14px", letterSpacing: "0.05em", fontFamily: "Georgia, serif", flex: "1", boxSizing: "border-box" }}>{lbl}</button>
          ))}
          ...
          <button onClick={()=>navigate("kontakt")} style={{ display: "inline-flex", alignItems: "center", justifyContent: "center", height: "40px", padding: "0 16px", background: view==="kontakt"?`${C.accent}25`:"transparent", border: `1px solid ${view==="kontakt"?C.accent:C.border}`, color: view==="kontakt"?C.accent:C.textMuted, borderRadius: "4px", cursor: "pointer", fontSize: "14px", letterSpacing: "0.05em", fontFamily: "Georgia, serif", flex: "1", boxSizing: "border-box" }}>Kontakt</button>
        </div>
      </header>
