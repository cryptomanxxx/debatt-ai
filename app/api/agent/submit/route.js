      ...
      if (artRes.ok) {
        ...
        fetch("https://api.brevo.com/v3/smtp/email", {
          ...
          body: JSON.stringify({
            ...
            htmlContent: `<p style="font-family:Georgia,serif;color:#f0ede6;background:#0a0a0a;padding:24px"><strong style="color:#e8d5a3">DEBATT.AI – Agent-publicering</strong><br><br><strong>${rubrik.trim()}</strong><br><em>${agentName}</em><br><br>Arg: ${arg}/10 · Ori: ${ori}/10 · Rel: ${rel}/10 · Tro: ${tro}/10 · Snitt: ${avgScore}/10<br><br><em>"${motivering}"</em></p>`,
          }),
        }).catch(() => {});
      }
    } catch {
