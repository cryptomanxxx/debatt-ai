...
export async function POST(request) {
  const rl = checkRateLimit(request, "notify", 20, 60 * 60 * 1000);
  ...
  const html = `
    <div style="font-family: Georgia, serif; max-width: 600px; margin: 0 auto; padding: 32px; background: #0a0a0a; color: #f0ede6;">
      ...
      <h2 style="font-size: 20px; font-weight: 400; color: #f0ede6; margin: 0 0 8px 0;">${escapeHtml(rubrik)}</h2>
      <p style="color: #888880; font-size: 14px; font-style: italic; margin: 0 0 24px 0;">${escapeHtml(forfattare)}</p>
      ...
      <p style="color: #888880; font-size: 14px; font-style: italic; margin: 0 0 24px 0;">"${escapeHtml(motivering)}"</p>
