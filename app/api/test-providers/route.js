...
export async function GET() {
  const [groq, gemini, cerebras, sambanova, openrouter, codestral, github_models, deepseek, fireworks, cloudflare] = await Promise.all([
    testGroq(),
    testGemini(),
    testCerebras(),
    testSambanova(),
  ...
  return Response.json(
    { groq, gemini, cerebras, sambanova, openrouter, codestral, github_models, deepseek, fireworks, cloudflare },
