...
const C = {
  ...
  green: "#4ade80", blue: "#4a9eff", red: "#f87171", yellow: "#f472b6",
};
...
const NAV = (href, lbl, active) => (
  <a key={href} href={href} style={{
    ...
    background: active ? "#f472b625" : "transparent",
...
function kategoriFarg(kat) {
  return { krypto: "#f7931a", makro: C.blue, politik: "#f472b6", tech: "#34d399", övrigt: C.textMuted }[kat] || C.textMuted;
}
      ...
      {rankning.length === 0 ? (
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "6px" }}>
          {rankning.slice(0, 8).map((r, i) => {
            ...
            const medalColor = i === 0 ? "#f472b6" : i === 1 ? "#94a3b8" : i === 2 ? "#b87333" : C.textMuted;
