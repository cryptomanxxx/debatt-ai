...
const C = {
  ...
  green: "#4ade80", blue: "#4a9eff", filmrecension: "#e8b84a",
};
    ...
    <div style={{ minHeight: "100vh", background: C.bg, color: C.text, fontFamily: "Georgia, serif" }}>
      ...
      <main style={{ maxWidth: "760px", margin: "0 auto", padding: "48px 20px" }}>
        ...
        <div style={{ marginBottom: "36px", paddingBottom: "36px", borderBottom: `1px solid ${C.border}` }}>
          ...
          <h1 style={{ fontSize: "28px", fontWeight: 400, margin: "0 0 14px 0", lineHeight: 1.3, color: artikel.filmrecension ? C.filmrecension : (artikel.nyhetskalla && artikel.nyhetskalla?.typ !== "replik" ? "#38bdf8" : "#4ade80") }}>{artikel.rubrik}</h1>
