...
// 5 diskreta fonem-munformer baserade på amplitudnivå
function MouthOverlay({ cx, cy, amplitude, farg }) {
  ...
  return (
    <svg viewBox="0 0 100 100" style={{ position: "absolute", inset: 0, width: "100%", height: "100%", pointerEvents: "none" }}>
      {lvl === 0 && (
        <line x1={cx - 7} y1={cy} x2={cx + 7} y2={cy} stroke={farg + "77"} strokeWidth="1.8" strokeLinecap="round" />
      )}
      {lvl === 1 && (
        <>
          <ellipse cx={cx} cy={cy} rx={8} ry={1.8} fill="#0d0305" />
          <ellipse cx={cx} cy={cy} rx={8.5} ry={2.2} fill="none" stroke={farg + "66"} strokeWidth="0.8" />
        </>
      )}
      {lvl === 2 && (
        <>
          <ellipse cx={cx} cy={cy} rx={8.5} ry={4} fill="#0d0305" />
          <ellipse cx={cx} cy={cy - 2.8} rx={8.5} ry={1.4} fill={farg + "88"} />
          <ellipse cx={cx} cy={cy + 3}   rx={7.5} ry={1.1} fill={farg + "55"} />
        </>
      )}
      {lvl === 3 && (
        <>
          <ellipse cx={cx} cy={cy}       rx={9}   ry={6.5} fill="#0d0305" />
          <ellipse cx={cx} cy={cy + 3.5} rx={5}   ry={2.5} fill="#b8353580" />
          <ellipse cx={cx} cy={cy - 5}   rx={9}   ry={1.8} fill={farg + "99"} />
          <ellipse cx={cx} cy={cy + 5.5} rx={8}   ry={1.3} fill={farg + "66"} />
        </>
      )}
      {lvl === 4 && (
        <>
          <ellipse cx={cx} cy={cy}       rx={9.5} ry={8.5} fill="#0d0305" />
          <ellipse cx={cx} cy={cy + 4.5} rx={5.5} ry={3}   fill="#b8353599" />
          <ellipse cx={cx} cy={cy - 7}   rx={9.5} ry={2.2} fill={farg + "aa"} />
          <ellipse cx={cx} cy={cy + 7.5} rx={8.5} ry={1.6} fill={farg + "77"} />
        </>
      )}
      {/* Röd kalibreringspunkt — syns alltid */}
      <circle cx={cx} cy={cy} r={1.2} fill="#ff4444cc" />
    </svg>
  );
}

function AgentTestCard({ namn, pos, onPosChange, amplitude, speaking, onTest }) {
    ...
    <div style={{ background: C.surface, border: `1px solid ${C.border}`, borderRadius: "12px", padding: "20px", flex: "1 1 220px" }}>
      ...
      <div style={{ marginBottom: "12px" }}>
        <div style={{ display: "flex", justifyContent: "space-between", marginBottom: "4px" }}>
          <label style={{ fontSize: "11px", color: C.textMuted, letterSpacing: "0.08em", textTransform: "uppercase" }}>cx (vänster/höger)</label>
      ...
      <div style={{ marginBottom: "20px" }}>
        <div style={{ display: "flex", justifyContent: "space-between", marginBottom: "4px" }}>
          <label style={{ fontSize: "11px", color: C.textMuted, letterSpacing: "0.08em", textTransform: "uppercase" }}>cy (upp/ner)</label>
      ...
      <div style={{ maxWidth: "900px", margin: "0 auto" }}>
        ...
        <div style={{ display: "flex", alignItems: "flex-start", marginBottom: "32px" }}>
          <div>
            ...
            <h1 style={{ fontSize: "26px", fontWeight: 400, margin: "0 0 6px 0" }}>Mun-kalibrering</h1>
            <p style={{ color: C.textMuted, fontSize: "13px", margin: 0 }}>
              Röd punkt = centrum. Justera CX/CY tills punkten sitter på munnen. Kopiera värdena till MOUTH_POS i app/podd/page.js.
            </p>
          </div>
        ...
        <div style={{ marginBottom: "28px" }}>
          <p style={{ fontSize: "11px", color: C.textMuted, letterSpacing: "0.1em", textTransform: "uppercase", margin: "0 0 8px 0" }}>Testmening</p>
        ...
        <div style={{ background: C.surface, border: `1px solid ${C.border}`, borderRadius: "8px", padding: "20px" }}>
          ...
          <pre style={{ fontSize: "12px", color: C.accent, fontFamily: "monospace", margin: 0, whiteSpace: "pre-wrap", wordBreak: "break-all" }}>
            {posJson}
          </pre>
        </div>
