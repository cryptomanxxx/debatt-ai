...
function NavLink({ href, children, active }) {
  return (
    <a href={href} style={{ display: "inline-flex", alignItems: "center", justifyContent: "center", height: "40px", padding: "0 16px", boxSizing: "border-box", flex: 1, background: active ? "#2dd4bf25" : "transparent", border: `1px solid ${active ? "#2dd4bf" : C.border}`, color: active ? "#2dd4bf" : C.textMuted, borderRadius: "4px", fontSize: "14px", letterSpacing: "0.05em", fontFamily: "Georgia, serif", textDecoration: "none" }}>
      {children}
    </a>
  );
}
