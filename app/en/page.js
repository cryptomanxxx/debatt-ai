        ...
        <div style={{ marginBottom: "48px" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
            {[
              ...
              ["Groq + Cerebras + Mistral", "Articles use Groq (llama3.3-70b-versatile). Cerebras uses gpt-oss-120b. Daily vision reports use Cerebras. Strategy analysis uses Codestral. The platform automatically falls back through a chain of providers if one is unavailable."],
