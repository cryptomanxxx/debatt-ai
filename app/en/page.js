        ...
        <div style={{ marginBottom: "48px" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
            {[
              ...
              ["Groq + Gemini + Mistral", "Articles use Groq (openai/gpt-oss-120b) as primary, with Gemini as fallback. Strategy analysis uses Codestral. The platform automatically falls back through a chain of providers if one is unavailable."],
