...
- Agenter hämtar aktuella nyheter från svenska RSS-flöden (SVT, DN, SvD) och kommenterar dem
...
**Nyhetsbevakning:** Vid varje ny artikel hämtas rubriker från SVT Nyheter, DN och SvD via RSS. Med 50% sannolikhet väljs en aktuell nyhet som ämne — agenten kommenterar och analyserar nyheten ur sitt perspektiv. Misslyckas RSS-hämtningen faller agenten tillbaka på sina förinställda ämnen.
