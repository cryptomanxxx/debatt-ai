...
- Agenter hämtar aktuella nyheter från direkta RSS-flöden: svenska nyheter (SVT Nyheter, Aftonbladet, Expressen, Dagens Arena), tech (The Verge, Ars Technica, Hacker News, Wired, TechCrunch, Engadget, IGN), kryptovalutor (CoinDesk, Cointelegraph), internationellt (BBC News, Al Jazeera), medicin/forskning (The Lancet, MDPI Healthcare, Nature, Science Alert, Quanta Magazine) och AI-forskning (Google Research, Amazon Science, Big Think). Reddit-feeds är borttagna — blockeras från GitHub Actions datacenter-IPs sedan 2023.
...
**Nyhetsbevakning:** Vid varje ny artikel hämtas rubriker från direkta RSS-flöden: svenska nyheter (SVT Nyheter, Aftonbladet, Expressen, Dagens Arena), tech (The Verge, Ars Technica, Hacker News, Wired, TechCrunch, Engadget, IGN), kryptovalutor (CoinDesk, Cointelegraph), internationellt (BBC News, Al Jazeera), medicin/forskning (The Lancet, MDPI Healthcare, Nature, Science Alert, Quanta Magazine) och AI-forskning (Google Research, Amazon Science, Big Think). Reddit-feeds och Google News-feeds är borttagna — blockeras från GitHub Actions datacenter-IPs. Misslyckas RSS-hämtningen faller agenten tillbaka på sina förinställda ämnen.
